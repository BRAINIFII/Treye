...
#    Aug 26, 2019 11:49:52 PM IST  platform: Windows NT
...
# conval = connect('Databases\data.db')
# curval = conval.cursor()
# curval.execute("DROP TABLE IF EXISTS Links")
# curval.execute("CREATE TABLE Links(Sr_No number(3),Title varchar(1000),Link varchar(20),Price number(10))")
def vp_start_gui():
...
class Toplevel1:
    ...
    def add_link(self):
        ...
        self.Label4_3.configure(text='Please wait Reading Data')
        root.update()
        to_add = varEntry.get()
        bitly_d=bitly.shorten(to_add)
        varEntry.set('')
        root.update()
        self.Label4_3.configure(text='Validating Data')
        root.update()
        treye.crawler(to_add,API_USER,API_KEY)
        self.Label4_3.configure(text='Product Found')
        root.update()
        time.sleep(1)
        url_title = treye.title()
        prod_price = treye.productprice()
        short_link = url_title[:33] + '..... Rs. ' + str(prod_price)
        self.Label4_3.configure(text='Adding Entry')
        root.update()
        time.sleep(2)
        self.lstbx1.insert('end',short_link)
        self.Label4_3.configure(text='Done')
        root.update()
        treye.notify()
        url_title = treye.title()
        prod_price = treye.productprice()
    ...
    def __init__(self, top=None):
        ...
        photo_location = os.path.join(prog_location,"../Python Project/icon/Main-01.png")
        global _img0
        ...
        # photo_location = os.path.join(prog_location,"../Python Project/icon/Minimize-01.png")
        # global _img3
        ...
        photo_location = os.path.join(prog_location,"../Python Project/icon/Add-02.png")
        global _img4
        ...
        photo_location = os.path.join(prog_location,"../Python Project/icon/Test-02.png")
        global _img6
