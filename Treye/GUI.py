...
# auto Entry
    ...
    def __init__(self, top=None):
        ...
        photo_location = os.path.join(prog_location,"../icon/Main-01.png")
        global _img0
        ...
        # photo_location = os.path.join(prog_location,"../icon/Minimize-01.png")
        # global _img3
        ...
        photo_location = os.path.join(prog_location,"../icon/Add-02.png")
        global _img4
        ...
        photo_location = os.path.join(prog_location,"../icon/Test-02.png")
        global _img6
        ...
        photo_location = os.path.join(prog_location,"../icon/intrefresh-01.png")
        global _img9
